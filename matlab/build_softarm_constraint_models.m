...
set_param(model,"InitFcn",contactDemoInit());
...
set_param(model+"/Constrained Plant","Bundle", ...
    "'../generated/extensible_euler_bernoulli_pcs_flying_plane_contact_n1'");
...
function code = contactDemoInit
code = "softarm_model_dir=fileparts(get_param(bdroot,'FileName'));" + ...
    "softarm_root=fileparts(fileparts(softarm_model_dir));" + ...
    "addpath(fullfile(softarm_root,'matlab'));" + ...
    "addpath(fullfile(softarm_root,'matlab','simulink'));" + ...
    "softarm.initModel(fullfile(softarm_root,'examples','generated'," + ...
    "'extensible_euler_bernoulli_pcs_flying_plane_contact_n1'));";
end
