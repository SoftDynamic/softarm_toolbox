...
code = "softarm_model_dir=fileparts(get_param(bdroot,'FileName'));" + ...
    ...
    "if evalin('base','exist(''softarm_bundle'',''var'')'),softarm_selected_bundle=evalin('base','softarm_bundle');else,softarm_selected_bundle=fullfile(softarm_root,'examples','generated','extensible_kirchhoff_pcs_three_tendon_n2');end;" + ...
...
set_param(model+"/Plant","Bundle","'../generated/extensible_kirchhoff_pcs_three_tendon_n2'");
