...
exampleFiles = [ ...
    "softarm_tendon_actuation_demo.slx", ...
...
load_system(fullfile(exampleDirectory,"softarm_tendon_actuation_demo.slx"));
cleanupActuation = onCleanup(@() close_system("softarm_tendon_actuation_demo",0));
references = find_system("softarm_tendon_actuation_demo", ...
...
verifyTrue(testCase,all(ismember( ...
    ["softarm_actuator_force_block", ...
    "softarm_actuator_acceleration_block","softarm_plant"],models)));
verifyQLog(testCase,"softarm_tendon_actuation_demo","Plant");
verifyEqual(testCase,get_param( ...
    "softarm_tendon_actuation_demo","EnablePacing"),'off');
verifyEqual(testCase,get_param( ...
    "softarm_tendon_actuation_demo","ReturnWorkspaceOutputs"),'off');
